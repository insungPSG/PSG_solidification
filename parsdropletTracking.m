...
folderXrayobj = 'X:\4000_SharedDataAnalysis\Xray_Objs'; %'Y:\4000_SharedDataAnalysis\Xray_Objs';
folderData    = 'X:\2021\I20210153\0009_a';
...
% ### Tracking parameters
TR.algorithm            = 'knn'; % 'hungarian', 'knn'
...
TR.costOfNonAssignment  = 1000;

% ## knn algorithm parameters 
TR.maxDist = 15; % Positive distance or leave it empty to switch off the filter

% ==========================================================================
% RESULTS SAVING INFO 

% ### Folder path
resultFolder = 'X:\4000_SharedDataAnalysis\flowAnalysis\EnzoTests'; %'G:\02_DataAnalysis\FluidFlow\Al-Pb_monotectic\Results_bulkLiquid\20190404';
